...
#img1
img1 = cv2.imread('C:\\Users\\Administrator\\Desktop/person1.png',
                  cv2.IMREAD_COLOR)
img2 = cv2.imread('C:\\Users\\Administrator\\Desktop/person2.png',
                  cv2.IMREAD_COLOR)
...
plt.subplot(1, 2, 1)
plt.title("Person One")
plt.imshow(img1)

plt.subplot(1, 2, 2)
plt.title("Persion Two")
plt.imshow(img2)
