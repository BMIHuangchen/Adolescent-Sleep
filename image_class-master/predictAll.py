...
#这块代码导致className报错？？？
    ...
    def Predict(self,emotion):
        ...
        count2 = 0
        count3 = 0
        path = r"F:/硕士论文/eeg-master/image_class-master/dataset/test/" + str(emotion) + '/'
        ...
        return str(str(accuracy)) + ',' + str(end - start) + ',' + str(count0) + ',' + str(count1) + ',' + str(count2) + ',' + str(count3)
